 ...
 *
 * Pure and Android-free on purpose. A widget is the one surface in this app nobody
 * looks at deliberately - it is read in passing, believed, and acted on - so the
 * branching behind the figure is worth being able to exercise exhaustively on the JVM
 * rather than by resizing a home screen and squinting at it.
 */
object WidgetState {
